...
/***/ (function(module, exports, __webpack_require__) {
	...
	var editStudentTemplate = __webpack_require__(34);
	$(function () {
	...
	$(function () {
	  ...
	  $('body').on('click', '.editStudent', function (event) {
	    ...
	    console.log(id);
	    var editStudentHtml = editStudentTemplate({ id: id });
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://thegreatmaster.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onRequest = function onRequest(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createRequest(data).then(ui.onRequestSuccess).catch(ui.onRequestFailure);
	};
	var onGetAllRequest = function onGetAllRequest() {
	  event.preventDefault();
	  // const data = getFormFields(event.target)
	  api.getAllRequest().then(ui.getAllRequestSuccess).catch(ui.getAllRequestFailure);
	};
	var onDeleteRequest = function onDeleteRequest(event) {
	  event.preventDefault();
	  console.log(event);
	  var id = $(event.target).parent().parent().attr('data-id');
	  console.log('this is what we need');
	  console.log(id);
	  api.deleteRequest(id).then(ui.DeleteRequestSuccess(event)).catch(ui.DeleteRequestFailure);
	};
	var onCreateStudent = function onCreateStudent(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createStudent(data).then(ui.onCreateStudentSuccess).catch(ui.onCreateStudentFailure);
	};
	var onGetAllStudent = function onGetAllStudent() {
	  event.preventDefault();
	  api.getAllStudent().then(ui.getAllStudentSuccess).catch(ui.getAllStudentFailure);
	};
	var onDeleteStudent = function onDeleteStudent(event) {
	  ...
	  console.log('this is what we need');
	  console.log(id);
	  api.deleteStudent(id).then(ui.deleteStudentSuccess(event)).catch(ui.deleteStudentFailure);
	};
	var onUpdateStudent = function onUpdateStudent(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  var id = $(event.target).attr('data-id');
	  console.log(id, data);
	  api.updateStudentInfo(id, data).then(ui.onUpdateStudentSuccess).catch(ui.onUpdateStudentfailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var getAllRequest = function getAllRequest() {
	  return $.ajax({
	    url: config.apiOrigin + '/requests',
	    method: 'GET',
	    headers: {
	...
	var deleteRequest = function deleteRequest(data) {
	  return $.ajax({
	...
	var createStudent = function createStudent(data) {
	  return $.ajax({
	...
	var getAllStudent = function getAllStudent() {
	  return $.ajax({
	    url: config.apiOrigin + '/students',
	    method: 'GET',
	    headers: {
	...
	var updateStudentInfo = function updateStudentInfo(id, data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showRequestTemplate = __webpack_require__(12);
	var showStudentTemplate = __webpack_require__(32);
	var showSingleStudentTemplate = __webpack_require__(33);
	...
	var getAllRequestSuccess = function getAllRequestSuccess(data) {
	  if (data.requests.length === 0) {
	    $('.head').hide();
	    $('#success').show();
	    $('#succmsg').text('no request on the list');
	  } else {
	    var showrequestHtml = showRequestTemplate({
	...
	var getAllRequestFailure = function getAllRequestFailure(error) {
	  console.log(error);
	};
	var DeleteRequestSuccess = function DeleteRequestSuccess(event) {
	  console.log(event);
	  console.log('this is event target:', $(event.target));
	  $(event.target).parent().parent().remove();
	};
	var DeleteRequestFailure = function DeleteRequestFailure(error) {
	  console.log(error);
	};
	var getAllStudentSuccess = function getAllStudentSuccess(data) {
	  if (data.students.length === 0) {
	    ...
	    $('#student-table').show();
	    $('.head1').show();
	    var showstudentHtml = showStudentTemplate({
	...
	var onCreateStudentSuccess = function onCreateStudentSuccess(data) {
	  $('#student-table').show();
	  $('.head1').show();
	  $('.form-control').val('');
	  var showsinglestudentHtml = showSingleStudentTemplate({
	    student: data.student
	  });
	  // $('#studentAdd').html(showstudentHtml)
	  $('#studentAdd').append(showsinglestudentHtml);
	};
	var onUpdateStudentSuccess = function onUpdateStudentSuccess(data) {
	...
	var onUpdateStudentFailure = function onUpdateStudentFailure(error) {
	  console.error(error);
	};
	var deleteStudentSuccess = function deleteStudentSuccess(event) {
	  console.log(event);
	  console.log('this is event target:', $(event.target));
	  $(event.target).parent().parent().remove();
	};
	...
	module.exports = {
	  ...
	  getAllRequestSuccess: getAllRequestSuccess,
	  getAllRequestFailure: getAllRequestFailure,
	  DeleteRequestSuccess: DeleteRequestSuccess,
	  DeleteRequestFailure: DeleteRequestFailure,
	  getAllStudentSuccess: getAllStudentSuccess,
	  onUpdateStudentSuccess: onUpdateStudentSuccess,
	  onUpdateStudentFailure: onUpdateStudentFailure,
	  deleteStudentSuccess: deleteStudentSuccess,
	  onCreateStudentSuccess: onCreateStudentSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<tr data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-default deleteRequest\">Delete</button></td>\n<td class=\"rname\" name=\"[request][name]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</td>\n<td class=\"rcontact\" name=\"[request][telephone]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.telephone : stack1), depth0))
	    + "</td>\n<td class=\"raddresss\" name=\"[request][address]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.address : stack1), depth0))
	    + "</td>\n<td class=\"rmessage\" name=\"[request][message]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.message : stack1), depth0))
	    + "</td>\n</tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.requests : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<tr data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-default deleteStudent\">Delete</button></td>\n  <td data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><button id=\"editStudent"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"btn btn-default editStudent\" data-toggle=\"modal\" data-target=\"#updateStudent\">Edit</button></td>\n  <td class=\"sname\" name=\"[student][name]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</td>\n  <td class=\"semail-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" name=\"[student][email]\">"
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.address : stack1), depth0))
	    + "</td>\n  <td class=\"sgender\" name=\"[student][gender]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.gender : stack1), depth0))
	    + "</td>\n  <td class=\"sdivision-"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"  name=\"[student][division]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.division : stack1), depth0))
	    + "</td>\n  <td class=\"sbirth\" name=\"student[dob]\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.dob : stack1), depth0))
	    + "</td>\n</tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.students : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<tr data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.student : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <td data-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.student : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\"><button id=\"deleteStudent"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.student : depth0)) != null ? stack1.id : stack1), depth0))
	    ...
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.student : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" name=\"[student][email]\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.student : depth0)) != null ? stack1.email : stack1), depth0))
	    + "</td>\n  <td class=\"saddress-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.student : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\"  name=\"[student][address]\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.student : depth0)) != null ? stack1.address : stack1), depth0))
	    + "</td>\n  <td class=\"sgender\" name=\"[student][gender]\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.student : depth0)) != null ? stack1.gender : stack1), depth0))
	    + "</td>\n  <td class=\"sdivision-"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.student : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\"  name=\"[student][division]\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.student : depth0)) != null ? stack1.division : stack1), depth0))
	    + "</td>\n  <td class=\"sbirth\" name=\"student[dob]\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.student : depth0)) != null ? stack1.dob : stack1), depth0))
	    + "</td>\n</tr>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<form class=\"std\" data-id=\""
	    + container.escapeExpression(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">\n  <div class=\"form-group\">\n    <label for=\"add\">Address:</label>\n    <input type=\"text\" name=\"student[address]\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"div\">class:</label>\n    <input type=\"text\" name=\"student[division]\" class=\"form-control\">\n  </div>\n  <div class=\"form-group\">\n    <label for=\"eml\">email:</label>\n    <input type=\"email\" name=\"student[email]\" class=\"form-control\">\n  </div>\n  <button type=\"submit\" class=\"btn btn-success btn-block editstud\">submit</button>\n</form>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "902e72edaba1bea6ff983f2b26b0f86e.jpg";

/***/ }),
/* 45 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "0ad75b32232cfd4a40280573f5227ee3.jpg";

/***/ }),
/* 46 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "42b3b1fb9b00683ffb29a7a27cf42912.jpg";
